...
function Banner() {
    return ( 
        <>
            <div className='md:mt-80 mt-[470px] sm:mb-0 -mb-96'>

                <div className='relative m-10'>
                    <div className='relative w-full h-72 bg-gradient-to-r from-[#9BFFA5] via-[#AED3FF] to-[#C9D4EF] border-0 rounded-md'></div>
                    <div className='absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center'>
                        <h1 className='text-4xl font-bold text-center w-80 text-slate-500'>Enjoy the seamless process of POS</h1>
