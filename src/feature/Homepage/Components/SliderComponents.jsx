...
const SliderComponents = () => {
  ...
  return (
    <div className="w-full overflow-x-hidden">
      <h1 className="bg-gradient-to-r from-[#373FFF] to-[#3ACAF8] bg-clip-text text-transparent font-bold font-roboto text-lg leading-6 text-center md:mt-28 mt-[400px] sm:mt-96 ">
        Testimonial
      </h1>
